...
class ModuleContainer extends IocContainer {
  ...
  public function configure() {
    ...
    $this->register(Processor\LessProcessor::class, Processor\PreProcessor\OyejorgeLessProcessor::class);
    $this->register(Processor\ScssProcessor::class, Processor\PreProcessor\LeafoScssProcessor::class);
  }
}